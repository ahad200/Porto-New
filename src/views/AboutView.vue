      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Muhammad Ahadiyas Hatumena. I'm a Software Engineer from South Jakarta. 
            I strongly interest in development, distributed systems and applying analytical skills to solve complex problems. have An experience in Full-Stack Developer.
            I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that
            has aesthetic value. Job is to build your website to be functional and user-friendly.
            The goals is to convey your message and identity in the most creative way.
