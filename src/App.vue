<template>
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">Dys.javascript</span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://github.com/ahad200"><img class="w-9 rounded-full" src="https://images.seeklogo.com/logo-png/30/1/github-logo-png_seeklogo-304612.png" alt="github"></a>
        </div>
          ...
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <router-link to="/Coming Soon"
                class="fadein-bot fadein-3 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0 blog">Coming Soon </router-link>
            </li>
          </ul>
        </div>
      </div>
  ...
  <nav class="flex justify-around py-4 text-xs">
    ...
    <router-link to="/Coming Soon" class="text-gray-300 hover:text-white">Coming Soon</router-link>
  </nav>
</footer>
</template>
